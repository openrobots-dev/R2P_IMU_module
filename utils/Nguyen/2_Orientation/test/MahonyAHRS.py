...
twoKp = twoKpDef; #volatile                                            #// 2 * proportional gain (Kp)
twoKi = twoKiDef; #volatile                                                #// 2 * integral gain (Ki)
q0 = 1.0; q1 = 0.0; q2 = 0.0; q3 = 0.0; #volatile                        #// quaternion of sensor frame relative to auxiliary frame
integralFBx = 0.0; integralFBy = 0.0; integralFBz = 0.0; #volatile        #// integral error terms scaled by Ki
