...
#-------------------------------------------------------------------------------
# Name:        cal_lib
# Purpose: This module will calculate magnetometer calibration params: scale factor, misalignment, offset.
#          This module is inherited from Varesano code which originally calculate scale factor and offset. It is then revised to take into account the misaglignment error.
#
# Revisor:      nguyen
#
# Created:     02/01/2013
...
#
#compute calibrated data with scale factor matrix, misalignment matrix and offset vector
#
...
#
#compute scale factor and offset, then call to method calibrate_misalignment to compute misalignment
#
...
#
#perform calibration process - data read from file
#
...
#
#compute calibrated data with only scale matrix and offset - Old code of Varesano
#
...
if __name__ == "__main__":
  ...
  (offsets, scale, misalignment) = calibrate_from_file("data\\magn.txt", "mag")
  print "Offsets:"
  print offsets
  print "Scales:"
  print scale
